...
class Bird:
    ...
    def update(self):
        ...
        if self.started:
            ...
            # self.rotated_img = pygame.transform.rotate(self.curr_img, self.angle)
            # self.bird_rect = self.rotated_img.get_rect(center = self.curr_img.get_rect(center = (self.bird_rect.centerx, self.bird_rect.centery)).center)
            ...
            self.angle = max(-90, self.angle-self.rotate)
            self.rotate += 0.05
